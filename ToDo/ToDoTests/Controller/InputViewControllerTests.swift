...
class InputViewControllerTests: XCTestCase {
	...
	func test_Save_UsesGeocoderToGetCoordinateFromAddress() {
		...
		let timestamp = 1456066800.0//1456095600.0
...
//			XCTAssertEqual(latitude, 0.0, accuracy: 0.001)
//			XCTAssertEqual(longitude, 0.0, accuracy: 0.001)
